...
console.log('');
console.log('  Listo. Abre cualquier proyecto en Claude Code y ejecuta:');
console.log('');
console.log('    /user:init-btw   — analiza el proyecto y genera el CLAUDE.md');
console.log('');
console.log('  Comandos disponibles tras el init:');
console.log('    /user:plan-implementation  — planea un requerimiento antes de implementar');
console.log('    /user:review               — revisión completa de cambios antes de PR');
console.log('    /user:commit-message       — genera mensaje de commit en Conventional Commits');
